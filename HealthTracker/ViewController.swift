...
class ViewController: UIViewController {
    ...
    private func showHealthForm() {
        let formView = HealthFormView(onSubmit: { [weak self] currentWeight, goalWeight, wantsClearSkin, dailyWaterIntake, exerciseHours, sleepHours in
            ...
            // Handle form submission and navigate to the next view
    ...
    private func navigateToOptions(currentWeight: String, goalWeight: String, wantsClearSkin: String, dailyWaterIntake: String, exerciseHours: String, sleepHours: String) {
        ...
        let optionsView = OptionsView(
            ...
            onIngredientCheck: {
                // Handle Ingredient Check action
            },
            onMealPlan: {
